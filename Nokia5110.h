...
#endif
// Máximas dimensiones de la LCD, aunque los niveles´pueden ser
// numerados desde sero a (MAX-1).  Las direciones pueden ser 
// incrementadas despues de la transmision 
#define MAX_X                   84
#define MAX_Y                   48
/********* Dimensiones de la patalla **********************/
#define SCREENW     84
#define SCREENH     48

// Valor del contraste 
// Ajustar desde 0xA0 (claro) to 0xCF (oscuro) para el display
